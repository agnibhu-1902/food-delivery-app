    ...
    <div className='add'>
        <form className="flex-col" onSubmit={onSubmitHandler}>
            ...
            <div className="add-product-name flex-col">
                <p>Product Name</p>
                <input onChange={onChangeHandler} type="text" name='name' value={data.name} placeholder='Type here' required />
            </div>
            ...
            <div className="add-category-price">
                ...
                <div className="add-price flex-col">
                    <p>Product Price</p>
                    <input onChange={onChangeHandler} type="number" min="0" name='price' value={data.price} placeholder='₹0' required />
                </div>
            </div>
